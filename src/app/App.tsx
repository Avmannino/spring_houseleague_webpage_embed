...
const STANDINGS_DATA: Record<AgeGroup, StandingsRow[]> = {
  Mites: [
    { team: "USA", wins: 1, losses: 1, ties: 0 },
    { team: "Germany-NRLH", wins: 1, losses: 1, ties: 0 },
  ],
  Squirt: [
    { team: "Sweden", wins: 2, losses: 0, ties: 0 },
    { team: "Germany", wins: 1, losses: 1, ties: 0 },
    { team: "Canada", wins: 1, losses: 1, ties: 0 },
    { team: "USA", wins: 0, losses: 2, ties: 0 },
  ],
  Peewee: [
    { team: "Netherlands", wins: 2, losses: 0, ties: 0 },
    { team: "Finland", wins: 2, losses: 0, ties: 0 },
    { team: "Germany", wins: 0, losses: 2, ties: 0 },
    { team: "Sweden", wins: 0, losses: 2, ties: 0 },
  ],
  Bantam: [
    { team: "Finland", wins: 2, losses: 0, ties: 0 },
    { team: "Germany", wins: 1, losses: 1, ties: 0 },
    { team: "Canada", wins: 0, losses: 1, ties: 1 },
    { team: "Sweden", wins: 0, losses: 1, ties: 1 },
  ],
  "U16-18": [
    { team: "USA", wins: 2, losses: 0, ties: 0 },
    { team: "Canada", wins: 1, losses: 1, ties: 0 },
    { team: "Netherlands", wins: 1, losses: 1, ties: 0 },
    { team: "Finland", wins: 0, losses: 2, ties: 0 },
  ],
};
...
const ROSTER_DATA: Record<AgeGroup, RosterPlayer[]> = {
  ...
  Squirt: [
    ...
    { id: "squirt-r-29", team: "Germany-NRLH", firstName: "Dylan", lastName: "Martins" },
    { id: "squirt-r-30", team: "Germany-NRLH", firstName: "Hank", lastName: "Hollander" },
    { id: "squirt-r-31", team: "Germany-NRLH", firstName: "Liam", lastName: "Frusciante" },
    { id: "squirt-r-32", team: "Germany-NRLH", firstName: "Sean", lastName: "Finnegan" },
    { id: "squirt-r-33", team: "Germany-NRLH", firstName: "Langston", lastName: "Basile" },
    { id: "squirt-r-34", team: "Germany-NRLH", firstName: "Brenton", lastName: "Weiner" },

    { id: "squirt-r-35", team: "Canada", firstName: "Cameron", lastName: "Feeley", isGoalie: true },
    { id: "squirt-r-36", team: "Sweden", firstName: "Leo", lastName: "McGlynn", isGoalie: true },
    { id: "squirt-r-37", team: "Canada", firstName: "Logan", lastName: "Thorne", isGoalie: true },
    { id: "squirt-r-38", team: "USA", firstName: "Luke", lastName: "Ziegert Maron", isGoalie: true },
    { id: "squirt-r-39", team: "Germany-NRLH", firstName: "Jacob", lastName: "Lokerson", isGoalie: true },
    { id: "squirt-r-40", team: "USA", firstName: "James", lastName: "Lacey", isGoalie: true },
    { id: "squirt-r-41", team: "Germany-NRLH", firstName: "Roman", lastName: "Rusinowicz", isGoalie: true },
  ],
  ...
  Peewee: [
    ...
    { id: "peewee-r-8", team: "Netherlands", firstName: "Owen", lastName: "Erensen" },
    { id: "peewee-r-9", team: "Netherlands", firstName: "Oliver", lastName: "Hunter" },
    { id: "peewee-r-10", team: "Netherlands", firstName: "Theo", lastName: "Adams" },
    ...
    { id: "peewee-r-14", team: "Sweden", firstName: "Leo", lastName: "Tilton" },
    { id: "peewee-r-15", team: "Sweden", firstName: "John", lastName: "Greenstein" },
    ...
    { id: "peewee-r-19", team: "Germany-NRLH", firstName: "Desi", lastName: "Criscuolo" },
    { id: "peewee-r-20", team: "Germany-NRLH", firstName: "West", lastName: "Mandes" },
    { id: "peewee-r-21", team: "Germany-NRLH", firstName: "Maddie", lastName: "Schwefel" },
    { id: "peewee-r-22", team: "Germany-NRLH", firstName: "Mika", lastName: "Macleod" },
    { id: "peewee-r-23", team: "Germany-NRLH", firstName: "Hayes", lastName: "Macleod" },
    { id: "peewee-r-24", team: "Germany-NRLH", firstName: "Sebastian", lastName: "Kronewitter" },

    { id: "peewee-r-25", team: "Finland", firstName: "Luke", lastName: "DeMarco", isGoalie: true },
    { id: "peewee-r-26", team: "Finland", firstName: "Noah", lastName: "Lovejoy", isGoalie: true },
    { id: "peewee-r-27", team: "Germany-NRLH", firstName: "Hudson", lastName: "Basile", isGoalie: true },
    { id: "peewee-r-28", team: "Netherlands", firstName: "Michael", lastName: "Nyarady", isGoalie: true },
    { id: "peewee-r-29", team: "Netherlands", firstName: "Trip", lastName: "Graham", isGoalie: true },
  ...
  Bantam: [
    ...
    { id: "bantam-r-19", team: "Sweden", firstName: "Graydon", lastName: "Kronewitter" },
    { id: "bantam-r-20", team: "Sweden", firstName: "Jaquelyn", lastName: "Farson" },

    { id: "bantam-r-21", team: "Finland", firstName: "Hunter", lastName: "Ward" },
    { id: "bantam-r-22", team: "Finland", firstName: "Luke", lastName: "Salib" },
    { id: "bantam-r-23", team: "Finland", firstName: "Ryan", lastName: "Hellinger" },
    { id: "bantam-r-24", team: "Finland", firstName: "Juliana", lastName: "Ebanks" },
    { id: "bantam-r-25", team: "Finland", firstName: "Teddy", lastName: "Jordan" },
    { id: "bantam-r-26", team: "Finland", firstName: "Reva", lastName: "Tilton" },
    { id: "bantam-r-27", team: "Finland", firstName: "Jordy", lastName: "Hellinger" },
    { id: "bantam-r-28", team: "Finland", firstName: "Jake", lastName: "Schwefel" },
    { id: "bantam-r-29", team: "Finland", firstName: "Leighton", lastName: "Equale" },
    { id: "bantam-r-30", team: "Finland", firstName: "Joy", lastName: "Adams" },
    { id: "bantam-r-31", team: "Finland", firstName: "Bennett", lastName: "Van Dusen" },

    { id: "bantam-r-32", team: "Germany", firstName: "Mason", lastName: "Warwick" },
    { id: "bantam-r-33", team: "Germany", firstName: "Dylan", lastName: "Zalis" },
    { id: "bantam-r-34", team: "Germany", firstName: "Arthur", lastName: "Butcher" },
    { id: "bantam-r-35", team: "Germany", firstName: "Dino", lastName: "Ibrahim" },
    { id: "bantam-r-36", team: "Germany", firstName: "Charles", lastName: "Bittman" },
    { id: "bantam-r-37", team: "Germany", firstName: "Ian", lastName: "Bishop" },
    { id: "bantam-r-38", team: "Germany", firstName: "Max", lastName: "Magnant" },
    { id: "bantam-r-39", team: "Germany", firstName: "Jaden", lastName: "Vazquez" },
    { id: "bantam-r-40", team: "Germany", firstName: "Luke", lastName: "Scaramella" },
    { id: "bantam-r-41", team: "Germany", firstName: "Charlotte", lastName: "Bishop" },

    { id: "bantam-r-42", team: "Canada", firstName: "Grace", lastName: "Garcia", isGoalie: true },
    { id: "bantam-r-43", team: "Sweden", firstName: "Patrick", lastName: "Melton", isGoalie: true },
    { id: "bantam-r-44", team: "Finland", firstName: "Anèleah", lastName: "Stahl", isGoalie: true },
    { id: "bantam-r-45", team: "Finland", firstName: "Ryan", lastName: "Feinstein", isGoalie: true },
    { id: "bantam-r-46", team: "Germany", firstName: "Louis", lastName: "Thorne", isGoalie: true },
    { id: "bantam-r-47", team: "Sweden", firstName: "Luke", lastName: "DeMarco", isGoalie: true },
    { id: "bantam-r-48", team: "Germany", firstName: "Chase", lastName: "Hammock", isGoalie: true },
  ],
  ...
  "U16-18": [
    ...
    { id: "u16-r-21", team: "Netherlands", firstName: "Jacob", lastName: "Solomon" },

    { id: "u16-r-22", team: "Canada", firstName: "Andrew", lastName: "Salce" },
    { id: "u16-r-23", team: "Canada", firstName: "Alex", lastName: "Lonergan" },
    { id: "u16-r-24", team: "Canada", firstName: "Mack", lastName: "Grillo" },
    { id: "u16-r-25", team: "Canada", firstName: "Alexander", lastName: "Morin" },
    { id: "u16-r-26", team: "Canada", firstName: "Quinn", lastName: "Murphy" },
    { id: "u16-r-27", team: "Canada", firstName: "Henry", lastName: "Schwefel" },
    { id: "u16-r-28", team: "Canada", firstName: "Will", lastName: "Staffieri" },
    { id: "u16-r-29", team: "Canada", firstName: "Bo", lastName: "Carpenteri" },
    { id: "u16-r-30", team: "Canada", firstName: "Lachlan", lastName: "Welch" },
    { id: "u16-r-31", team: "Canada", firstName: "Asher", lastName: "Kepler" },
    { id: "u16-r-32", team: "Canada", firstName: "Jakob", lastName: "Pollack" },

    { id: "u16-r-33", team: "Finland", firstName: "Andrew", lastName: "Erensen" },
    { id: "u16-r-34", team: "Finland", firstName: "Ryan", lastName: "Mora" },
    { id: "u16-r-35", team: "Finland", firstName: "Brendan", lastName: "OBrien" },
    { id: "u16-r-36", team: "Finland", firstName: "James", lastName: "Orrico" },
    { id: "u16-r-37", team: "Finland", firstName: "Zach", lastName: "Tuers" },
    { id: "u16-r-38", team: "Finland", firstName: "Luke", lastName: "Vartuli" },
    { id: "u16-r-39", team: "Finland", firstName: "Colton", lastName: "Green" },
    { id: "u16-r-40", team: "Finland", firstName: "Thomas", lastName: "Lomasney" },
    { id: "u16-r-41", team: "Finland", firstName: "Gabriel", lastName: "De Carvalho" },
    { id: "u16-r-42", team: "Finland", firstName: "Cooper", lastName: "O'Toole" },
    { id: "u16-r-43", team: "Finland", firstName: "Thomas", lastName: "Lomasney" },

    { id: "u16-r-44", team: "Canada", firstName: "Tiago", lastName: "Da Silva", isGoalie: true },
    { id: "u16-r-45", team: "Netherlands", firstName: "Bill", lastName: "Salib", isGoalie: true },
    { id: "u16-r-46", team: "Finland", firstName: "Henry", lastName: "Levin", isGoalie: true },
    { id: "u16-r-47", team: "USA", firstName: "Liam", lastName: "Feinstein", isGoalie: true },
    { id: "u16-r-48", team: "USA", firstName: "Graham", lastName: "Speck", isGoalie: true },
  ],
};
