...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1340] flex flex-col sm:block">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="lg:-ml-[30px]">
              <div className="flex flex-col items-start mb-6">
                <img src={logo} alt="Wings Arena" className="w-[96.04px] mt-[-15px] mb-2 ml-[72px]" />
                <h1 className="text-4xl lg:text-5xl text-white">Public Skate</h1>
              </div>
              <div className="text-gray-300 mb-6 space-y-4">
                <p>
                  Lace up and hit the ice at our Public Skate—the perfect chance to get out on the ice. Whether you're practicing your skills, staying active, or just skating for fun, we welcome all ages and skill levels!
                </p>
                <p>
                  No skates? No problem—we've got a wide range of rental sizes from youth to adult, with both hockey and figure skates available.
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                <a href="#schedule" className="bg-[#b2dbd7] text-gray-900 px-6 py-3 rounded-md hover:bg-[#9ccbc7] hover:scale-105 transition-all inline-block">
                  View Schedule
                </a>
                <a href="#pricing" className="bg-transparent text-white px-6 py-3 rounded-md border border-gray-500 hover:bg-gray-800 hover:scale-105 transition-all inline-block">
                  Pricing Info
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-8">
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="lg:col-span-2 lg:-ml-[75px] -mt-[47px] lg:mt-[15px] order-1">
              <h2 className="text-[1.84125rem] sm:text-3xl mb-6 text-white text-center">This Week's Public Skates</h2>
            ...
            <div className="order-2 lg:hidden mt-0">
              <h2 className="text-[2rem] sm:text-[2.15625rem] mb-4 sm:mb-8 text-white text-center mt-[10px] sm:mt-0">Pricing</h2>
            ...
            <div className="space-y-[23px] sm:space-y-[26px] lg:mt-14 lg:ml-[50px] lg:w-[calc(100%-5px)] mt-[40px] lg:-mt-[25px] w-[85%] mx-auto lg:mx-0 lg:w-[calc(100%-5px)] order-3">
              <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 sm:p-6 lg:mt-3.75">
                <h3 className="text-white mb-2 text-center lg:text-left">Skate Rentals</h3>
                <p className="text-gray-300 text-sm text-center lg:text-left">Hockey & figure skates in youth and adult sizes</p>
              </div>
              <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 sm:p-6 lg:mt-6.25">
                <h3 className="text-white mb-2 text-center lg:text-left">Spectator Seating</h3>
                <p className="text-gray-300 text-sm text-center lg:text-left">Ample space for parents and guests to watch</p>
              </div>
              <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 sm:p-6 lg:mt-[30px]">
                <h3 className="text-white mb-2 text-center lg:text-left">Helmets Recommended</h3>
                <p className="text-gray-300 text-sm text-center lg:text-left">Especially for kids and first-time skaters</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="hidden lg:block max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 py-12 lg:-mt-[10px]">
        <h2 className="text-[2rem] sm:text-[2.15625rem] mb-8 text-white text-center">Pricing</h2>
      ...
      <section className="bg-[#0f1340] py-12 pb-4 sm:pb-12 -mt-[30px] sm:mt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-[1.9625rem] sm:text-[2.0625rem] mb-6 sm:mb-8 text-white text-center">Parties & Ice Bookings</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 w-[70%] sm:w-full max-w-4xl mx-auto gap-8 sm:gap-12 lg:gap-[72px]">
            <div className="bg-gray-800 rounded-lg border border-gray-700 p-[1.65375rem] text-center">
              <h3 className="text-white text-[1.378125rem] sm:text-[1.65375rem] mb-4 -mt-[5px]">Birthday Parties</h3>
              <a
            ...
            <div className="bg-gray-800 rounded-lg border border-gray-700 p-[1.65375rem] text-center">
              <h3 className="text-white text-[1.378125rem] sm:text-[1.65375rem] mb-4 -mt-[5px]">Private Ice Bookings</h3>
              <a
              ...
              >
                <img src={catchCornerLogo} alt="Book with CatchCorner" className="h-[3.3075rem] sm:h-[4.41rem] rounded-md" />
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 py-12 -mt-[40px] sm:mt-0 order-2 sm:order-none">
        <h2 className="text-2xl sm:text-3xl mb-6 sm:mb-8 text-white text-center">Gallery</h2>
      ...
      <section className="bg-[#0f1340] py-12 sm:py-12 pt-0 sm:pt-12 order-1 sm:order-none mt-[35px] sm:mt-0">
        <div className="max-w-[58.08rem] mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl mb-6 sm:mb-8 text-white text-center">Frequently Asked Questions</h2>
          <Accordion type="single" collapsible className="bg-[#b2dbd7] rounded-lg border border-gray-700 px-4 sm:px-6">
            <AccordionItem value="item-1">
              <AccordionTrigger>Do I need to bring my own skates?</AccordionTrigger>
              <AccordionContent>
                No, skate rentals are available for a small fee. We have sizes for all ages, from toddlers to adults. However, you're welcome to bring your own skates if you prefer.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>What should I wear to public skate?</AccordionTrigger>
              <AccordionContent>
                We recommend wearing comfortable, warm clothing that allows for movement. Long pants are recommended, and layers are ideal as the rink temperature is kept cool. Gloves or mittens are strongly encouraged for hand protection.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>Are skating aids available for beginners?</AccordionTrigger>
              <AccordionContent>
                Yes, we have skating aids available to help beginners learn to skate (limited quantity). These are especially helpful for young children and first-time skaters. Staff members are also available to provide basic guidance.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>Can I book a birthday party or group event?</AccordionTrigger>
              <AccordionContent>
                Absolutely! We host birthday parties and group event bookings. These include reserved skating time, party room rental, and various add-on options. For more info and availability, email our Events Coordinator - jwanderlingh@wingsarena.com
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
