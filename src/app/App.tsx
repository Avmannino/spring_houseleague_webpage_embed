...
const ROSTER_DATA: Record<AgeGroup, RosterPlayer[]> = {
  ...
  Bantam: [
    ...
    { id: "bantam-r-44", team: "Canada", firstName: "Grace", lastName: "Garcia", isGoalie: true },
    { id: "bantam-r-45", team: "Sweden", firstName: "Patrick", lastName: "Melton", isGoalie: true },
    { id: "bantam-r-46", team: "Finland", firstName: "Anèleah", lastName: "Stahl", isGoalie: true },
    { id: "bantam-r-47", team: "Finland", firstName: "Ryan", lastName: "Feinstein", isGoalie: true },
    { id: "bantam-r-48", team: "Germany", firstName: "Louis", lastName: "Thorne", isGoalie: true },
    { id: "bantam-r-49", team: "Sweden", firstName: "Luke", lastName: "DeMarco", isGoalie: true },
    { id: "bantam-r-50", team: "Germany", firstName: "Chase", lastName: "Hammock", isGoalie: true },
  ],

  "U16-18": [
    { id: "u16-r-1", team: "USA", firstName: "Lucas", lastName: "Oliver" },
    { id: "u16-r-2", team: "USA", firstName: "Cooper", lastName: "Auerswald" },
    { id: "u16-r-3", team: "USA", firstName: "Jake", lastName: "McQuillan" },
    { id: "u16-r-4", team: "USA", firstName: "Isaac", lastName: "Snedeker" },
    { id: "u16-r-5", team: "USA", firstName: "Langston", lastName: "Worth" },
    { id: "u16-r-6", team: "USA", firstName: "Topher", lastName: "Kern" },
    { id: "u16-r-7", team: "USA", firstName: "Charlie", lastName: "Tusa" },
    { id: "u16-r-8", team: "USA", firstName: "William", lastName: "Lewis" },
    { id: "u16-r-9", team: "USA", firstName: "Max", lastName: "Corbo" },
    { id: "u16-r-10", team: "USA", firstName: "Auggie", lastName: "Krueger" },
    { id: "u16-r-11", team: "USA", firstName: "Cook", lastName: "Van Wyck" },
    { id: "u16-r-12", team: "USA", firstName: "Mannle", lastName: "Stafford" },
    ...
    { id: "u16-r-15", team: "Netherlands", firstName: "Hailey", lastName: "Dreher" },
    { id: "u16-r-16", team: "Netherlands", firstName: "Kiki", lastName: "Worden" },
    { id: "u16-r-17", team: "Netherlands", firstName: "John", lastName: "Greifzu III" },
    { id: "u16-r-18", team: "Netherlands", firstName: "Alexa", lastName: "Kwasniewski" },
    { id: "u16-r-19", team: "Netherlands", firstName: "Lexi", lastName: "Lisjak" },
    { id: "u16-r-20", team: "Netherlands", firstName: "Ethan", lastName: "Brown-Toussaint" },
    { id: "u16-r-21", team: "Netherlands", firstName: "Jake", lastName: "Spitz" },
    { id: "u16-r-22", team: "Netherlands", firstName: "Thomas", lastName: "Lomasney" },
    { id: "u16-r-23", team: "Netherlands", firstName: "Aidan", lastName: "Murray" },
    { id: "u16-r-24", team: "Netherlands", firstName: "Dylan", lastName: "Murray" },
    { id: "u16-r-25", team: "Netherlands", firstName: "Anderson", lastName: "Wiener" },

    { id: "u16-r-26", team: "Canada", firstName: "Andrew", lastName: "Salce" },
    { id: "u16-r-27", team: "Canada", firstName: "Alex", lastName: "Lonergan" },
    { id: "u16-r-28", team: "Canada", firstName: "Mack", lastName: "Grillo" },
    { id: "u16-r-29", team: "Canada", firstName: "Alexander", lastName: "Morin" },
    { id: "u16-r-30", team: "Canada", firstName: "Quinn", lastName: "Murphy" },
    { id: "u16-r-31", team: "Canada", firstName: "Henry", lastName: "Schwefel" },
    { id: "u16-r-32", team: "Canada", firstName: "Will", lastName: "Staffieri" },
    { id: "u16-r-33", team: "Canada", firstName: "Bo", lastName: "Carpenteri" },
    { id: "u16-r-34", team: "Canada", firstName: "Lachlan", lastName: "Welch" },
    { id: "u16-r-35", team: "Canada", firstName: "Asher", lastName: "Kepler" },
    { id: "u16-r-36", team: "Canada", firstName: "Jakob", lastName: "Pollack" },
    { id: "u16-r-37", team: "Canada", firstName: "Billy", lastName: "McGarvey" },

    { id: "u16-r-38", team: "Finland", firstName: "Andrew", lastName: "Erensen" },
    { id: "u16-r-39", team: "Finland", firstName: "Ryan", lastName: "Mora" },
    { id: "u16-r-40", team: "Finland", firstName: "Brendan", lastName: "OBrien" },
    { id: "u16-r-41", team: "Finland", firstName: "James", lastName: "Orrico" },
    { id: "u16-r-42", team: "Finland", firstName: "Zach", lastName: "Tuers" },
    { id: "u16-r-43", team: "Finland", firstName: "Luke", lastName: "Vartuli" },
    { id: "u16-r-44", team: "Finland", firstName: "Colton", lastName: "Green" },
    { id: "u16-r-45", team: "Finland", firstName: "Gabriel", lastName: "De Carvalho" },
    { id: "u16-r-46", team: "Finland", firstName: "Cooper", lastName: "O'Toole" },
    { id: "u16-r-47", team: "Finland", firstName: "Thomas", lastName: "Lomasney" },
    { id: "u16-r-48", team: "Finland", firstName: "Jonah", lastName: "Guttman" },
    { id: "u16-r-49", team: "Finland", firstName: "Myer", lastName: "Guttman" },
    { id: "u16-r-50", team: "Finland", firstName: "Ethan", lastName: "Brown-Toussaint" },

    { id: "u16-r-51", team: "Canada", firstName: "Tiago", lastName: "Da Silva", isGoalie: true },
    { id: "u16-r-52", team: "Netherlands", firstName: "Bill", lastName: "Salib", isGoalie: true },
    { id: "u16-r-53", team: "Finland", firstName: "Henry", lastName: "Levin", isGoalie: true },
    { id: "u16-r-54", team: "USA", firstName: "Liam", lastName: "Feinstein", isGoalie: true },
    { id: "u16-r-55", team: "USA", firstName: "Graham", lastName: "Speck", isGoalie: true },
    { id: "u16-r-56", team: "Netherlands", firstName: "Jacob", lastName: "Solomon", isGoalie: true },
  ],
};
