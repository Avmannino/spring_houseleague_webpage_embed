...
const ROSTER_DATA: Record<AgeGroup, RosterPlayer[]> = {
  Mites: [
    ...
    { id: "mites-r-12", team: "Germany-NRLH", firstName: "Lucas", lastName: "Chiavaroli" },
    { id: "mites-r-13", team: "Germany-NRLH", firstName: "Finn", lastName: "Clark" },
    ...
    { id: "mites-r-19", team: "Germany-NRLH", firstName: "Tucker", lastName: "Miller" },
    { id: "mites-r-20", team: "Germany-NRLH", firstName: "Jack", lastName: "Aleman", isGoalie: true },
  ],
  ...
  Squirt: [
    ...
    { id: "squirt-r-32", team: "Germany-NRLH", firstName: "Langston", lastName: "Basile" },
    { id: "squirt-r-33", team: "Germany-NRLH", firstName: "Brenton", lastName: "Weiner" },

    { id: "squirt-r-34", team: "Canada", firstName: "Cameron", lastName: "Feeley", isGoalie: true },
    { id: "squirt-r-35", team: "Sweden", firstName: "Leo", lastName: "McGlynn", isGoalie: true },
    { id: "squirt-r-36", team: "Canada", firstName: "Logan", lastName: "Thorne", isGoalie: true },
    { id: "squirt-r-37", team: "USA", firstName: "Luke", lastName: "Ziegert Maron", isGoalie: true },
    { id: "squirt-r-38", team: "Germany-NRLH", firstName: "Jacob", lastName: "Lokerson", isGoalie: true },
    { id: "squirt-r-39", team: "USA", firstName: "James", lastName: "Lacey", isGoalie: true },
    { id: "squirt-r-40", team: "Germany-NRLH", firstName: "Roman", lastName: "Rusinowicz", isGoalie: true },
  ],
  ...
  Peewee: [
    ...
    { id: "peewee-r-8", team: "Finland", firstName: "Owen", lastName: "Erensen" },

    { id: "peewee-r-9", team: "Netherlands", firstName: "Oliver", lastName: "Hunter" },
    { id: "peewee-r-10", team: "Netherlands", firstName: "West", lastName: "Mandes" },
    { id: "peewee-r-11", team: "Netherlands", firstName: "Kingsley", lastName: "Stagg" },
    { id: "peewee-r-12", team: "Netherlands", firstName: "Reeve", lastName: "Saypol" },
    { id: "peewee-r-13", team: "Netherlands", firstName: "Matthew", lastName: "Staffieri" },
    { id: "peewee-r-14", team: "Netherlands", firstName: "Leo", lastName: "Tilton" },
    { id: "peewee-r-15", team: "Netherlands", firstName: "Daniel", lastName: "Berger" },

    { id: "peewee-r-16", team: "Sweden", firstName: "Maxwell", lastName: "Lim" },
    { id: "peewee-r-17", team: "Sweden", firstName: "Hayes", lastName: "Kwasniewski" },
    { id: "peewee-r-18", team: "Sweden", firstName: "Jude", lastName: "Cassidy" },
    { id: "peewee-r-19", team: "Sweden", firstName: "Desi", lastName: "Criscuolo" },
    { id: "peewee-r-20", team: "Sweden", firstName: "Theo", lastName: "Adams" },
    { id: "peewee-r-21", team: "Sweden", firstName: "Maddie", lastName: "Schwefel" },
    { id: "peewee-r-22", team: "Sweden", firstName: "Mika", lastName: "Macleod" },
    { id: "peewee-r-23", team: "Sweden", firstName: "Sebastian", lastName: "Kronewitter" },

    { id: "peewee-r-24", team: "Germany-NRLH", firstName: "Brendan", lastName: "Messar" },
    { id: "peewee-r-25", team: "Germany-NRLH", firstName: "Jackson", lastName: "Morzan" },
    { id: "peewee-r-26", team: "Germany-NRLH", firstName: "Calder", lastName: "Tortorella" },
    { id: "peewee-r-27", team: "Germany-NRLH", firstName: "Quintin", lastName: "Moreno" },
    { id: "peewee-r-28", team: "Germany-NRLH", firstName: "Dylan", lastName: "Martins" },
    { id: "peewee-r-29", team: "Germany-NRLH", firstName: "Kieran", lastName: "Farrelly" },
    { id: "peewee-r-30", team: "Germany-NRLH", firstName: "Daniel", lastName: "Berger" },
    { id: "peewee-r-31", team: "Germany-NRLH", firstName: "Estella", lastName: "Park" },
    { id: "peewee-r-32", team: "Germany-NRLH", firstName: "Zachary", lastName: "Stern" },
    { id: "peewee-r-33", team: "Germany-NRLH", firstName: "Johan", lastName: "Perez" },

    { id: "peewee-r-34", team: "Finland", firstName: "Luke", lastName: "DeMarco", isGoalie: true },
    { id: "peewee-r-35", team: "Netherlands", firstName: "Michael", lastName: "Nyarady", isGoalie: true },
    { id: "peewee-r-36", team: "Netherlands", firstName: "Trip", lastName: "Graham", isGoalie: true },
    ...
    { id: "peewee-r-40", team: "Finland", firstName: "Noah", lastName: "Lovejoy", isGoalie: true },
  ],
  ...
  Bantam: [
    ...
    { id: "bantam-r-9", team: "Canada", firstName: "Violet", lastName: "Priisi" },

    { id: "bantam-r-10", team: "Sweden", firstName: "Thomas", lastName: "Miranowski" },
    { id: "bantam-r-11", team: "Sweden", firstName: "Max", lastName: "Gordon" },
    { id: "bantam-r-12", team: "Sweden", firstName: "Jason", lastName: "Vartuli" },
    { id: "bantam-r-13", team: "Sweden", firstName: "Willet", lastName: "Carpenteri" },
    { id: "bantam-r-14", team: "Sweden", firstName: "Quinn", lastName: "Kwasniewsk" },
    { id: "bantam-r-15", team: "Sweden", firstName: "Angus", lastName: "Valentine" },
    { id: "bantam-r-16", team: "Sweden", firstName: "Chole", lastName: "Gaggin" },
    { id: "bantam-r-17", team: "Sweden", firstName: "Jack", lastName: "Vives" },
    { id: "bantam-r-18", team: "Sweden", firstName: "Graydon", lastName: "Kronewitter" },
    { id: "bantam-r-19", team: "Sweden", firstName: "Jaquelyn", lastName: "Farson" },

    { id: "bantam-r-20", team: "Finland", firstName: "Hunter", lastName: "Ward" },
    { id: "bantam-r-21", team: "Finland", firstName: "Luke", lastName: "Salib" },
    { id: "bantam-r-22", team: "Finland", firstName: "Ryan", lastName: "Hellinger" },
    { id: "bantam-r-23", team: "Finland", firstName: "Juliana", lastName: "Ebanks" },
    { id: "bantam-r-24", team: "Finland", firstName: "Teddy", lastName: "Jordan" },
    { id: "bantam-r-25", team: "Finland", firstName: "Reva", lastName: "Tilton" },
    { id: "bantam-r-26", team: "Finland", firstName: "Jordy", lastName: "Hellinger" },
    { id: "bantam-r-27", team: "Finland", firstName: "Jake", lastName: "Schwefel" },
    { id: "bantam-r-28", team: "Finland", firstName: "Leighton", lastName: "Equale" },
    { id: "bantam-r-29", team: "Finland", firstName: "Joy", lastName: "Adams" },
    { id: "bantam-r-30", team: "Finland", firstName: "Bennett", lastName: "Van Dusen" },

    { id: "bantam-r-31", team: "Germany", firstName: "Mason", lastName: "Warwick" },
    { id: "bantam-r-32", team: "Germany", firstName: "Dylan", lastName: "Zalis" },
    { id: "bantam-r-33", team: "Germany", firstName: "Arthur", lastName: "Butcher" },
    { id: "bantam-r-34", team: "Germany", firstName: "Dino", lastName: "Ibrahim" },
    { id: "bantam-r-35", team: "Germany", firstName: "Charles", lastName: "Bittman" },
    { id: "bantam-r-36", team: "Germany", firstName: "Ian", lastName: "Bishop" },
    { id: "bantam-r-37", team: "Germany", firstName: "Max", lastName: "Magnant" },
    { id: "bantam-r-38", team: "Germany", firstName: "Jaden", lastName: "Vazquez" },
    { id: "bantam-r-39", team: "Germany", firstName: "Luke", lastName: "Scaramella" },
    { id: "bantam-r-40", team: "Germany", firstName: "Charlotte", lastName: "Bishop" },

    { id: "bantam-r-41", team: "Canada", firstName: "Grace", lastName: "Garcia", isGoalie: true },
    { id: "bantam-r-42", team: "Sweden", firstName: "Patrick", lastName: "Melton", isGoalie: true },
    { id: "bantam-r-43", team: "Finland", firstName: "Anèleah", lastName: "Stahl", isGoalie: true },
    { id: "bantam-r-44", team: "Finland", firstName: "Ryan", lastName: "Feinstein", isGoalie: true },
    { id: "bantam-r-45", team: "Germany", firstName: "Louis", lastName: "Thorne", isGoalie: true },
    { id: "bantam-r-46", team: "Sweden", firstName: "Luke", lastName: "DeMarco", isGoalie: true },
    { id: "bantam-r-47", team: "Germany", firstName: "Chase", lastName: "Hammock", isGoalie: true },
  ],
  ...
  "U16-18": [
    ...
    { id: "u16-r-8", team: "USA", firstName: "Topher", lastName: "Kern" },
    { id: "u16-r-9", team: "USA", firstName: "Charlie", lastName: "Tusa" },
    { id: "u16-r-10", team: "USA", firstName: "William", lastName: "Lewis" },

    { id: "u16-r-11", team: "Netherlands", firstName: "Sasha", lastName: "Miranowski" },
    { id: "u16-r-12", team: "Netherlands", firstName: "Jackson", lastName: "Kronewitter" },
    { id: "u16-r-13", team: "Netherlands", firstName: "Hailey", lastName: "Dreher" },
    { id: "u16-r-14", team: "Netherlands", firstName: "Kiki", lastName: "Worden" },
    { id: "u16-r-15", team: "Netherlands", firstName: "John", lastName: "Greifzu III" },
    { id: "u16-r-16", team: "Netherlands", firstName: "Auggie", lastName: "Krueger" },
    ...
    { id: "u16-r-21", team: "Canada", firstName: "Andrew", lastName: "Salce" },
    { id: "u16-r-22", team: "Canada", firstName: "Alex", lastName: "Lonergan" },
    { id: "u16-r-23", team: "Canada", firstName: "Mack", lastName: "Grillo" },
    { id: "u16-r-24", team: "Canada", firstName: "Alexander", lastName: "Morin" },
    { id: "u16-r-25", team: "Canada", firstName: "Quinn", lastName: "Murphy" },
    { id: "u16-r-26", team: "Canada", firstName: "Henry", lastName: "Schwefel" },
    { id: "u16-r-27", team: "Canada", firstName: "Will", lastName: "Staffieri" },
    { id: "u16-r-28", team: "Canada", firstName: "Bo", lastName: "Carpenteri" },
    { id: "u16-r-29", team: "Canada", firstName: "Lachlan", lastName: "Welch" },
    { id: "u16-r-30", team: "Canada", firstName: "Asher", lastName: "Kepler" },

    { id: "u16-r-31", team: "Finland", firstName: "Andrew", lastName: "Erensen" },
    { id: "u16-r-32", team: "Finland", firstName: "Ryan", lastName: "Mora" },
    { id: "u16-r-33", team: "Finland", firstName: "Brendan", lastName: "OBrien" },
    { id: "u16-r-34", team: "Finland", firstName: "James", lastName: "Orrico" },
    { id: "u16-r-35", team: "Finland", firstName: "Zach", lastName: "Tuers" },
    { id: "u16-r-36", team: "Finland", firstName: "Luke", lastName: "Vartuli" },
    { id: "u16-r-37", team: "Finland", firstName: "Colton", lastName: "Green" },
    { id: "u16-r-38", team: "Finland", firstName: "Thomas", lastName: "Lomasney" },
    { id: "u16-r-39", team: "Finland", firstName: "Gabriel", lastName: "De Carvalho" },
    { id: "u16-r-40", team: "Finland", firstName: "Cooper", lastName: "O'Toole" },
    { id: "u16-r-41", team: "Finland", firstName: "Thomas", lastName: "Lomasney" },

    { id: "u16-r-42", team: "Canada", firstName: "Tiago", lastName: "Da Silva", isGoalie: true },
    { id: "u16-r-43", team: "Netherlands", firstName: "Bill", lastName: "Salib", isGoalie: true },
    { id: "u16-r-44", team: "Finland", firstName: "Henry", lastName: "Levin", isGoalie: true },
    { id: "u16-r-45", team: "USA", firstName: "Liam", lastName: "Feinstein", isGoalie: true },
    { id: "u16-r-46", team: "USA", firstName: "Graham", lastName: "Speck", isGoalie: true },
  ],
};
